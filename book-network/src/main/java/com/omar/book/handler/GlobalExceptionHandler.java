...
import static com.omar.book.handler.BusinessErrorCodes.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleException(Exception exp) {
        // TODO logging handling in the app
        exp.printStackTrace();
        return ResponseEntity
                .status(INTERNAL_SERVER_ERROR)
                .body(
    ...
    @ExceptionHandler(OperationNotPremieredException.class)
    public ResponseEntity<ExceptionResponse> handleException(OperationNotPremieredException exp) {
        return ResponseEntity
                .status(BAD_REQUEST)
                .body(
                        ExceptionResponse.builder()
